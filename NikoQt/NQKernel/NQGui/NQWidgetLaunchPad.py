...
class NQWidgetLaunchPad(NQBasicWidget):
    ...
    def __init__(self,
        ...
        super(NQWidgetLaunchPad, self).__init__(w_name, w_title, **kwargs)

    def construct(self):
        vertical_compressor = QVBoxLayout()
        horizontal_compressor = QHBoxLayout()
        main_lay = QGridLayout()

        vertical_compressor.addStretch()
        vertical_compressor.addLayout(horizontal_compressor)
        vertical_compressor.addStretch()

        horizontal_compressor.addStretch()
        horizontal_compressor.addLayout(main_lay)
        horizontal_compressor.addStretch()

        self.main_lay = main_lay
        self.setLayout(vertical_compressor)
